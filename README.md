...
Сначала скопируем предыдущую ЛР:
```sh
$ git clone https://github.com/DimaSokkk/lab03 lab04
$ cd ~/lab04
$ git remote remove origin
$ git remote add origin https://github.com/DimaSokkk/lab04.git
```
